            ...
            <ul>
                ...
                <li data-index="rs-layers" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="500"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption tp-resizeme z-index-15"
                        ...
                        <h2 class="font-xlight">Privacy Policy </h2>
                    </div>
                   <!--  <div class="tp-caption tp-resizeme z-index-15"
                         data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
...
<section id="about" class="single-feature mt-4">
    <div class="container">
        <div class="mb-5">
            <p><b>This Privacy Policy was last updated: 1st May, 2020 .</b></p>
            <p>ZooBiz India Pvt. Ltd. an Indian organization located at 101,Parshwa Tower, S.G Highway, Bodakdev, Ahmedabad, India – 380054 (“ZooBiz India Pvt. Ltd.”) values your privacy. In this Privacy Policy (“Policy”), we describe the information that we collect about you when you visit our website, <a href="https://www.zoobiz.in">https://www.zoobiz.in/</a> and use the services available on the Website (“Services”), and how we use and disclose that information. </p>
            <p>If you have any questions or comments about the Privacy Policy, please contact us at connect@zoobiz.in . This Policy is incorporated into and is subject to the ZooBiz India Pvt. Ltd.’s Terms of Use, which can be accessed at <a href="https://www.zoobiz.in">https://www.zoobiz.in/privacyPolicy</a>. Your use of the Website and/or Services and any personal information you provide on the Website remains subject to the terms of the Policy and ZooBiz India Pvt. Ltd.’s Terms of Use.</p>
            </p>
        </div>
        <div class="mb-5">
            <h5>COLLECTION OF PERSONAL INFORMATION </h5>
            <hr>
            <p>“Personal information” is defined as information that whether on its own or in combination with other information may be used to readily identify or contact you such as: name, address, email address, phone number etc.</p>

            <p><b>Service Users:</b> During the Account registration process, we will collect information such as your name, postal code, contact number, email address and other personal information. You also may provide us with your mailing address, and demographic information (e.g., gender, age, political preference, education, race or ethnic origin, and other information relevant to user surveys and/or offers). We may also collect personal information that you post in your Offer, Profile, Wants, or Feedback, and any comments or discussions you post in any blog, chat room, or other correspondence site on the  mobile application, or any comments you provide during dispute resolution with other users of the Website or mobile application. </p>

            <p><b>Service Providers:</b> If you are a Service Provider and would like to post any information about yourself, we will require you to register for an Account. During the Account registration process, we will collect your business name, telephone number, address, zip code, travel preferences, a description of your services, a headline for your profile, first and last name, and email address. In addition, you may, but are not required to, provide other content or information about your business, including photographs and videos. We also may collect payment information, such as credit card information, from you.
            ...
            <p> We collect personal information from Service Providers offering their products and services. This information is partially or completely accessible to all visitors using ZooBiz website or mobile application. Service Providers and Service Users are required to create an account to be able to access certain portions of our website, such as to submit questions, participate in polls or surveys, to request a quote, to submit a bid in response to a quote, and request information. – Service Providers, if and when they create an account with ZooBiz India Pvt. Ltd., will be required to disclose information including personal contact details, agree to participation in polls or surveys or feedbacks or any other information that can help customer satiate their needs. The type of personal information that we collect from you varies based on your particular interaction with our Website or mobile application.</p>
        </div>
        <div class="mb-5">
        ...
        <div class="mb-5">
            ...
            <hr>
            <p>We invite you to post content on our Website, including your comments, feedback, pictures, and any other information that you would like to be available on our Website. If you post content to our Website, all of the information that you post will be available to all visitors to our Website. If you post your own content on our Website or Services, your posting may become public and ZooBiz India Pvt. Ltd. cannot prevent such information from being used in a manner that may violate this Policy, the law, or your personal privacy.</p>
        </div>
        <div class="mb-5">
            <h5>Privacy Policy Updates</h5>
            <hr>
            <p>THIS POLICY IS CURRENT AS OF THE EFFECTIVE DATE SET FORTH ABOVE. ZooBiz India Pvt. Ltd. MAY, IN ITS SOLE AND ABSOLUTE DISCRETION, CHANGE THIS POLICY FROM TIME TO TIME BY UPDATING THIS DOCUMENT. ZooBiz India Pvt. Ltd. WILL POST ITS UPDATED POLICY ON THE WEBSITE ON THIS PAGE. ZooBiz India Pvt. Ltd. ENCOURAGES YOU TO REVIEW THIS POLICY REGULARLY FOR ANY CHANGES. YOUR CONTINUED USE OF THIS WEBSITE AND/OR CONTINUED PROVISION OF PERSONAL INFORMATION TO US WILL BE SUBJECT TO THE TERMS OF THE THEN-CURRENT POLICY.</p>
        </div>
    </div>
</section>
<!--Some Feature ends-->
