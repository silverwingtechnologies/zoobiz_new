            ...
            <table class="table table-bordered mTable">
              ...
              <tr>
                ...
                <td  class="text-center">
                  ...
                  $q3=$d->select("users_master,user_employment_details,business_categories,business_sub_categories","    business_sub_categories.business_sub_category_id=user_employment_details.business_sub_category_id AND   business_categories.business_category_id=user_employment_details.business_category_id AND user_employment_details.user_id=users_master.user_id  AND users_master.user_token!='' AND users_master.active_status=0   AND    users_master.office_member = 0  and users_master.city_id='$selected_city_id' order by users_master.last_login desc","");
            ...
            <table id="example" class="table table-bordered">
              ...
              <tbody>
                ...
                $i=1;
                  ...
                  $q4=$d->selectRow("count(*) as counter,version_code,device", "users_master,user_employment_details,business_categories,business_sub_categories","    business_sub_categories.business_sub_category_id=user_employment_details.business_sub_category_id AND   business_categories.business_category_id=user_employment_details.business_category_id AND user_employment_details.user_id=users_master.user_id  AND users_master.user_token!='' AND users_master.active_status=0   AND    users_master.office_member = 0   and users_master.city_id='$selected_city_id'  group by version_code,device  order by version_code desc ",""); 
