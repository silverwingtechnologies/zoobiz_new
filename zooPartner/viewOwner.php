      ...
      <div class="col-lg-4">
       <div class="card profile-card-2">
        <div class="card-img-block">
          <img class="img-fluid" src="../zooAdmin/assets/images/gallery/31.jpg" alt="Card image cap">
        </div>
        <div class="card-body pt-5">
           <img id="blah"  onerror="this.src='../zooAdmin/img/user.png'" src="../img/users/recident_profile/<?php echo $user_profile_pic; ?>"  width="75" height="75"   src="#" alt="your image" class='profile' />
       ...
       <div class="card-body pt-2 text-center">
          <h5 class="card-title">Owner Details: 
             <div class="avatar">
              ...
              <img width="100" onerror="this.src='../zooAdmin/img/user.png'"  class="align-self-start mr-3" src="img/profile/<?php echo $ownerData['admin_profile']; ?>" alt="user avatar"><br>
         ...
         <tbody>
          ...
          while ($fData=mysqli_fetch_array($fq)) {
           ...
           <tr>
             <td><?php echo $i++; ?></td>
             <td>
                 <img id="blah"  onerror="this.src='../zooAdmin/img/user.png'" src="../img/users/recident_profile/<?php echo $fData['user_profile_pic']; ?>"  width="40" height="40"   src="#" alt="your image" class='profile' />
             </td>
