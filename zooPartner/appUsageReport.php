  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row pt-2 pb-2">
        <div class="col-sm-4">
          <h4 class="page-title">Members App Usage</h4>
           <ol class="breadcrumb">
           <li class="breadcrumb-item"><a href="welcome">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Members App Usage</li>
         </ol>
       </div>
        <div class="col-sm-6">
          <div class="">
          ...
          <div class="table-responsive">
            ...
            <table id="example" class="table table-bordered">
              ...
              <tbody>
                <?php 
                $i=1;
                $q3=$d->select("users_master,user_employment_details,business_categories,business_sub_categories"," business_sub_categories.business_sub_category_id=user_employment_details.business_sub_category_id AND   business_categories.business_category_id=user_employment_details.business_category_id AND user_employment_details.user_id=users_master.user_id  AND users_master.user_token!='' AND users_master.office_member=0 AND users_master.active_status=0 and users_master.city_id='$selected_city_id'   ","");
               while ($data=mysqli_fetch_array($q3)) {
                ...
                $totalUsage= $d->count_data_direct("app_usage_id","app_usage_master","user_id='$data[user_id]' AND usage_date_time BETWEEN '$nFrom' AND '$nTo'");
