  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row pt-2 pb-2">
        <div class="col-sm-4">
          <h4 class="page-title">Timeline Usage Report</h4>
          <ol class="breadcrumb">
           <li class="breadcrumb-item"><a href="welcome">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Timeline Usage Report</li>
         </ol>
       </div>
        <div class="col-sm-6">
          <div class="">
            ...
            <table id="example" class="table table-bordered">
              ...
              <tbody>
               ...
               while ($data=mysqli_fetch_array($q3)) {
                ...
                $totalUsage= $d->count_data_direct("timeline_id","timeline_master","user_id='$data[user_id]' AND created_date BETWEEN '$nFrom' AND '$nTo'");
