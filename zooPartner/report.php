							...
							<Br><br>
								...
								<div class="table-responsive">
									<table class="table table-bordered" id="example1">
										...
										<tbody>
											<?php
											$q3=$d->select("unit_master,block_master","block_master.block_id=unit_master.block_id AND  unit_master.remark_by = '$partner_login_id' ","ORDER BY unit_master.unit_id ASC");
											$i=1;
											while ($data=mysqli_fetch_array($q3)) {
											?>
