         ...
         //send user a welcome mail start
          ...
          //send user a welcome mail end
           ...
           /* $notiAry = array(
                        ...
                        //do not send SMS to admin, because we are sending sms at full profile time
$ref_by_data ="";
            ...
            $ref_by_data .=" -".$remark;
               ...
               /*$zoobiz_admin_master=$d->select("zoobiz_admin_master","send_notification = '1'    ");
                while($zoobiz_admin_master_data = mysqli_fetch_array($zoobiz_admin_master)) {
                 ...
                 $msg2=$user_full_name.' Has Joined '.$company_name. ' Referred by "'.$ref_by_data.'"'; 

                 // "New Member Registration in $company_name \n Name: $user_full_name \n Company Name: $company_name   \nThanks Team ZooBiz";
                 
                 //$d->send_sms($zoobiz_admin_master_data['admin_mobile'],$msg2);
                 $d->sms_to_admin_on_new_user_registration($zoobiz_admin_master_data['admin_mobile'], $user_full_name,$company_name,$ref_by_data );
