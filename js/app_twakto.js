...
(function(z) {
    ...
    try {
            ...
            fa = function() {
                ...
                this.forms = {
                    nameForm: {
                        ...
                        title: "MessageFormMessage",
                        fields: [{
                            fieldName: "message",
                            valueMaxLength: 40,
                            languageKey: "Message",
                            getValue: d.visitorHandler.getMessageValue,
                            validation: "isValidString",
                            type: "input",
                            isRequired: !0
                        }],
                        publish: "notifyMessageChange",
                        afterSave: d.visitorHandler.setMessageFromForm,
                        resize: "auto"
                    },
                    emailTranscriptForm: {
        ...
        var U = {
                ...
                changeMessageForm: '<div id="formFieldsContainer"><div class="formTable"><div class="formRow"><div class="formCell"><div class="formFrame"><div class="longFormContainer"><div id="formInnerHeight"><div id="form-header"><span class="form-header-icon"><span class="icon-user"></span></span><div class="form-header-text"><span>__CHANGE_NAME__</span></div>        </div><div id="changeNameFormMessageContainer" class="formMessageField">__TITLE__</div><fieldset><div class="inputContainer"><input type="text" id="nameField" value="__MESSAGE__" title="__NAME_PLACEHOLDER__" class="textInput" maxlength="40" placeholder="__NAME_PLACEHOLDER__" /></div><div id="nameFieldErrorIcon" class="formErrorIcon"><div class="icon-error field-error"></div></div></fieldset><div id="messageFieldError" class="formErrorContainer"></div></div></div><div class="longFormBottomContainer"><button id="formCancel" class="declineButton formButton">__CANCEL_BUTTON__</button><button id="formSubmit" class="approveButton formButton  theme-background-color theme-text-color">__SAVE_BUTTON__</button><div class="clear"></div></div></div></div></div></div></div><div id="submitWrapper"></div>',
        ...
        va.prototype.buildForm = function() {
            ...
            if (null === this.formData.dynamicFields &&
                ...
                for (var c = 0, e = f[b + "Options"].fields.length; c < e; c++) {
                    ...
                    "name" === h.type ? (g.valueMaxLength = 40, g.getValue = d.visitorHandler.getNameValue, g.languageKey = "Name") : "message" === h.type ? (g.valueMaxLength = 40, g.getValue = d.visitorHandler.getMessageValue, g.languageKey = "Message") :  "email" === h.type ? (g.valueMaxLength = 150, g.getValue = d.visitorHandler.getEmailValue, g.validation = "isValidEmail", g.languageKey = "Email") : "textarea" === h.type ? g.valueMaxLength = 500 : "text" === h.type ? g.valueMaxLength = 150 : "department" === h.type ? g.getValue = d.sessionHandler.getDeparmentOptions : "checkbox" === h.type || "radio" === h.type ? (g.type = "options", g.selections = h.selections) : "phone" === h.type && (g.valueMaxLength = 20, g.validation = "isValidPhone", g.languageKey = "Phone");
