...
$message= "<html>
            ...
            <h1 style='box-sizing: border-box; color: #2F3133; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 19px; font-weight: bold; margin-top: 0;' >Dear Admin!</h1>
            ...
            $user_full_name has approached Zoobiz for For Changing Business Name from <b>'$original_company_name'</b> to  <b>'$requested_company_name'</b>. </p>

            <p style='box-sizing: border-box; color: #74787E; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;' > 
<a href='$dashboardLink' target='_blank' >Link here</a>
</p>
