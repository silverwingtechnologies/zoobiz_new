...
<input type="hidden" name="merchant_id" value="345038"> 
<input type="hidden" name="working_key" value="CF33EDAC825B5B39BAFB5CD2C955F90B">
<input type="hidden" name="access_code" value="AVGK04IC24AQ98KGQA">
<input type="hidden" name="language" value="EN"> 
<input type="hidden" name="currency" value="INR"> 
<input type="hidden" name="redirect_url" value="<?php echo $base_url;?>zooAdmin/controller/ccavResponseHandler.php"> 
<input type="hidden" name="cancel_url" value="<?php echo $base_url;?>zooAdmin/controller/ccavResponseHandler.php"> 



       <div class="col-md-6 mt-4 col-sm-12" style="margin-top: 28px !important;" id="reg_btn">
          <button type="button" id="addNewMemberccAvenue" name="addNewMemberccAvenue" class="button gradient-btn w-100" > Pay With CCAvenue </button>
      </div>
