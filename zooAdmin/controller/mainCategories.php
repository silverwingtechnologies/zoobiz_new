                ...
                <tr>
                 ...
                 $totalCategory =  mysqli_num_rows($q3);
                  ...
                  <td><?php  if ($category_images!='') { ?>
                     ...
                     <?php } ?></td>
                 <td>
                     <a data-toggle="modal" data-target="#editCategory" href="javascript:void();" onclick="editCategory('<?php echo $data['business_category_id']; ?>','<?php echo $data['category_name']; ?>','<?php echo $data['category_images']; ?>','<?php echo $data['menu_icon']; ?>');" class="btn btn-sm btn-primary shadow-primary">Edit</a>
                 </td>
