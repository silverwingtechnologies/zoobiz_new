        ...
        <div class="card">
          <div class="card-body">
            <form id="manageSubCateFrm" action="controller/categoryController.php" method="post" >
              <input type="hidden" name="manageCategory" value="manageCategory">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4" >
               ...
               <input type="checkbox" <?php echo $ischecked;?> class="pagePrivilege" value="<?php echo $data['business_sub_category_id']; ?>" name="business_sub_category_id[]"  id="<?php echo $data['business_sub_category_id']; ?>"/>  
                <label for="<?php echo $data['business_sub_category_id']; ?>"><?php echo $data['sub_category_name']; ?> (<?php echo $data['category_name']; ?>)</label>
              </div>
              <?php
              $incounter++;
