  ...
  <div class="card">
    <div class="card-body">
      <ul class="nav nav-tabs nav-tabs-primary top-icon nav-justified">
        ...
        <li class="nav-item">
          <a href="javascript:void();" data-target="#Professional" data-toggle="pill" class="nav-link  active "><i class="fa fa-pencil"></i> <span class="hidden-xs">Interest </span></a>
        </li>
    ...
    <div class="tab-pane active" id="Professional">
      <form id="approveCustomIntFrm" action="controller/interestController.php" method="post" enctype="multipart/form-data">
        <div class="form-group row">
          <?php 
          $interest_master=$d->select("interest_master","interest_id='$interest_id'  ","");
$interest_master_data=mysqli_fetch_array($interest_master);
          ?>
        </div>
        <div class="proExtDiv">
        ...
        <div class="col-lg-9">
          ...
          <div class="form-group row">
        <label class="col-lg-3 col-form-label form-control-label">Interest Name <span class="required">*</span></label>
        <div class="col-lg-9">
           
          <input class="form-control mem-alphanumeric" name="interest_name" type="text" value="<?php echo $interest_master_data['interest_name'] ; ?>" required="">
        </div>
      </div>
          ...
          <div class="form-group row">
            <div class="col-lg-12 text-center">
              <input type="hidden" name="interest_id" value="<?php echo $interest_master_data['interest_id'];?>">
              <input type="hidden" name="user_id" value="<?php echo $user_id;?>">
               <input type="submit" id="appInterest" class="btn btn-primary" name="appInterest"  value="Approve">
 
<a href="controller/interestController.php?rejInterest=Reject&user_id=<?php echo $user_id;?>&interest_id=<?php echo $interest_master_data['interest_id'];?>" class="btn btn-danger"  >Reject</a>
