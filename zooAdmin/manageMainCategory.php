...
<div class="content-wrapper">
 ...
 $sub_id_array = array('0');           
 $sub_qry=$d->select("business_sub_categories","business_category_id ='$business_category_id'");
while ($sub_data=mysqli_fetch_array($sub_qry)) {
              $sub_id_array[] = $sub_data['business_sub_category_id'];
              }
$sub_id_array = implode(",", $sub_id_array);
              ...
              $business_sub_ctagory_relation_master=$d->select("business_sub_ctagory_relation_master"," business_sub_category_id in ($sub_id_array)");
              $data_array = array('0');
