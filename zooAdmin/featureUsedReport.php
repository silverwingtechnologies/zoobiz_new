  ...
  if($_REQUEST['feature_arr'] == 4 || $_REQUEST['feature_arr'] ==2){
     $meet_data_qry=$d->select(" meeting_master"," user_id in ($user_id_array) and  meeting_master.date  BETWEEN '$nFrom' AND '$nTo' ","");
  ...
  for ($l=0; $l < count($dataArray) ; $l++) {
   ...
   $totalChat = count($arr_new);
    ?> <td>Chat Added: <?php  echo $totalChat;?></td>
                    ...
                    <?php } ?> 
                     ...
                     $totalMeetupAccepted = count($arr_new2);
                      ...
                      ?>
                     <td>Meetup Requested: <?php echo $totalMeetupRequested;?><br>
                         Meetup Accepted: <?php echo $totalMeetupAccepted;?>
                     </td>
                    <?php } ?> 
  <?php  if($_REQUEST['feature_arr'] == 4 || $_REQUEST['feature_arr'] ==1){ 
  $arr_new3 =array(); 
...
$arr_new_cmt =array(); 
    ...
    ?>
                     <td>Classifieds Added: <?php echo $totalClassifieds;?><br>
                     Classifieds Comments: <?php echo $totalClassifiedsCmt;?> 
                     </td>
                    <?php } ?> 
                     ...
                     $totalTimelineCmt = count($arr_new_cmt);
                      ...
                      ?>
                    <td>Timeline Added: <?php echo $totalTimeline;?> <br>
                      Timeline Likes: <?php echo $totalTimelineLike;?> <br>
                      Timeline Comments: <?php echo $totalTimelineCmt;?> 
                     </td>
                    <?php } ?>
