               ...
               <?php 
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <?php  if(isset($_POST['editAddress'])) { ?>
                     ...
                     <textarea value="" required="" class="form-control" id="adress2" name="adress2"><?php echo $data['adress2'];?></textarea>
                   <?php } else { ?>
                      
                   <textarea value="" required="" class="form-control" id="adress2" name="adress2"></textarea>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <?php  
                    $u_id = $data['user_id'];
                    $q_add=$d->select("business_adress_master","user_id='$u_id'"); 
                    $disabled="";
                     if (mysqli_num_rows($q_add) ==1 ) {
                      $disabled = "disabled";
                     }?> 
                    <select required="" class="form-control" name="adress_type"  <?php echo $disabled; ?> >
                    ...
                    <?php if (mysqli_num_rows($q_add) ==1 ) {
                        ?>
                        <input type="hidden" name="adress_type" value="0">
                        <?php 
                     } ?> 
                  </div>
                </div>
