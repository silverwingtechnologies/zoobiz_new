...
<div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
        <h4 class="page-title">Add /Update Area</h4>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form id="addAreaFrm" action="controller/countryController.php" method="post" enctype="multipart/form-data">
               <?php 
                if(isset($_POST['editArea'])) {
                   extract(array_map("test_input" , $_POST));
                   $q=$d->select("area_master","area_id='$area_id'");
                  $data=mysqli_fetch_array($q);
                } 
                 ?>
                
                
                    <?php  if(isset($_POST['editArea'])) { ?>
                    <input type="hidden" name="area_id" value="<?php echo $area_id;?>">
                    <input  type="hidden" class="form-control" id="lat" name="latitude"  placeholder="Lattitude"  value="<?php echo $data['latitude']; ?>">
                     <input  type="hidden" class="form-control" id="lng"  name="longitude"  placeholder="sociaty_longitude" value="<?php echo $data['longitude']; ?>">
                     <input  type="hidden" class="form-control" id="adress" name="adress" value="<?php echo $data['adress'];?>">
                   <?php } else { ?>
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    ...
                    <input type="text" id="pincode" maxlength="6" value="<?php if(isset($_POST['editArea'])) { echo $data['pincode']; } ?>" required="" class="form-control onlyNumber" name="pincode" >
                  </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                     <input type="text" id="area_name" maxlength="50" value="<?php if(isset($_POST['editArea'])) { echo $data['area_name']; } ?>" required="" class="form-control" name="area_name" id="area_name">
                  </div>
