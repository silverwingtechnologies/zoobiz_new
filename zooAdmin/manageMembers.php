                ...
                <div class="card gradient-quepal no-bottom-margin">
                 ...
                 <h6 class="text-white mt-2">
                    ...
                    <span style="float: left;" class="user-profile" > 
                      ...
                      <img onerror="this.src='img/user.png'"  src="../img/users/members_profile/<?php echo $unitData['user_profile_pic']; ?>" class="img-circle" alt="user avatar"> <?php } else {?>
                        <img onerror="this.src='img/user.png'"  src="img/user.png" class="img-circle" alt="user avatar">
                       <?php } ?>  </i></span>
