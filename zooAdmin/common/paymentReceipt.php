...
$where=" and users_master.invoice_download=1  ";
   ...
   $qry =  $qp=$d->select("transection_master, user_employment_details ,business_adress_master,users_master,states,countries","countries.country_id=business_adress_master.country_id AND transection_master.user_id = users_master.user_id and
      ...
      users_master.user_id='$user_id' $where  ");
              ...
              <div class="card">
                ...
                <div class="row invoice-info">
                  ...
                  <div class="col-sm-6  text-right">
                    ...
                    <b>Invoice Date:</b> <?php echo date("d-m-Y", strtotime($mData['transection_date'])); ?><br>

                        <b>Received Date:</b> <?php if($mData['transection_date'] !="0000-00-00 00:00:00") { echo date("d-m-Y h:i A", strtotime($mData['transection_date'])); }   ?><br>
...
if($data456['paid_amount_with_gst'] > 0 ){
 ...
 if($data456['paid_amount_with_gst'] > 0 ){
  $package_master_data['package_amount'] =  ($data456['paid_amount_with_gst'] -$gst_amount);
}
