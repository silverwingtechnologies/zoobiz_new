...
<tr>
		...
		<p style='box-sizing: border-box; color: #74787E; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;' align='left'>You recently requested to reset your password for your ZooBiz account. Use the button below to reset it. <strong style='box-sizing: border-box; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;'>This password reset is only valid for the next 24 hours.</strong></p>
		...
		<p style='box-sizing: border-box; color: #74787E; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;' align='left'>If you did not request a password reset, please ignore this email or <a href='mailto:contact@zoobiz.com' style='box-sizing: border-box; color: #3869D4; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;'>contact support</a> if you have questions.</p>
		<p style='box-sizing: border-box; color: #74787E; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;' align='left'>Thank You,
		...
		<p class='sub' style='box-sizing: border-box; color: #74787E; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 1.5em; margin-top: 0;' align='left'>$forgotLink</p>
		</td>
		</tr>
		</table>
		</td>
