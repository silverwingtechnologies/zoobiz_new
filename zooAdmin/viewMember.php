...
<hr>
 ...
 <?php    $timeline_master_qry=$d->select("timeline_master","user_id ='$user_id'","");
  if(mysqli_num_rows($timeline_master_qry)>0) {  ?> 
 <hr>
 <div class="media align-items-center">
  <div>
   <i class="fa fa-info" aria-hidden="true"></i>  
 ...
 <div class="media-body text-left">
  <div class="progress-wrapper">Timeline: 
    
    <a target="_blank"  href="userTimeline?user_id=<?php echo $user_id;?>"   class="btn btn-secondary btn-sm" type="">View</a>
  </div>                   
</div>
</div>
<?php } ?> 
