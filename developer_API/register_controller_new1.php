...
$payment_gateway_array['redirect_url'] = $base_url.'/controller/ccavResponseHandler.php';
$payment_gateway_array['cancel_url'] = $base_url.'/controller/ccavResponseHandler.php';



if($currency_master_data['ccav_live_mode']=="Yes"){
