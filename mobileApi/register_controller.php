...
if (isset($_POST) && !empty($_POST)) {
	...
	if ($key == $keydb) {
		...
		if ($_POST['get_cities'] == "get_cities") {
		 ...
		 $iosLink = 'https://apps.apple.com/us/app/zoobiz/id1517343898?ls=1';
            ...
            'time' =>date("d M Y h:i A")
			 ...
			 if( $users_master_data['office_member'] =="0"){		 
  			$nResident->noti("viewMemeber","",0,$fcmArray,$title,$description,$user_id);
            $nResident->noti_ios("viewMemeber","",0,$fcmArrayIos,$title,$description,$user_id);
        }
