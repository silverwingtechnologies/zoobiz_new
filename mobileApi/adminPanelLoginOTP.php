...
$message = "
		...
		<title>GDMA Admin Panel Login OTP</title>
		...
		<h1 style='box-sizing: border-box; color: #2F3133; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 19px; font-weight: bold; margin-top: 0;' align='left'>Hi $admin_name,</h1>
		...
		<p class='sub align-center' style='box-sizing: border-box; color: #AEAEAE; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 1.5em; margin-top: 0;' align='center'>©".date('Y')."  GDMA. All rights reserved.</p>
