...
//echo "<pre>";print_r($member_added_details);exit;
		    ...
		    //get member added details
				...
				$qA2 = $d->select("area_master,business_adress_master,cities,states,countries", "business_adress_master.user_id='$user_id_org'
                AND
				...
				while ($data_app = mysqli_fetch_array($qA2)) {
					...
					$company_address["user_id_new"] = $user_id_org;
