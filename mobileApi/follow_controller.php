...
if (isset($_POST) && !empty($_POST)) {
    ...
    extract(array_map("test_input" , $_POST));
        ...
        if ($_POST['addFollow'] == "addFollow" && filter_var($user_id, FILTER_VALIDATE_INT) == true && filter_var($follow_to, FILTER_VALIDATE_INT) == true) {
            ...
            //5nov 2020
            if($user_id==$follow_to){
              $response["message"] = "You Can't Follow your profile";
                $response["status"] = "201";
                echo json_encode($response);
                exit();
            }
          ...
          //5nov 2020
            ...
            //5nov 2020
               ...
               $app_data=$d->select("users_master,follow_master,user_employment_details,business_categories,business_sub_categories","
