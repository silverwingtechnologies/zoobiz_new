	...
	if ($key == $keydb) {
		...
		if (isset($user_login) && $user_login == 'user_login') {
			...
			if ($member_date_of_birth != "") {
				echo strtotime($member_date_of_birth);
			  	$member_date_of_birth_test =    $member_date_of_birth  ;
				//$m->set_data('member_date_of_birth', date("Y-m-d", strtotime($member_date_of_birth)));
			} else {
				echo "HHHHH";
				//$m->set_data('member_date_of_birth', "");
				$member_date_of_birth_test ="";
			}

$m->set_data('member_date_of_birth', $member_date_of_birth_test);
